...
{\it System Research Engineer} %\\ %Mentor: Dr. Marc De Kruijf

\item {\bf NetApp Inc.}, San Jose, USA \hfill 2022 -- 2022 \\
{\it Senior Software Engineer} %\\ %Mentor: Dr. Marc De Kruijf
...
\begin{enumerate}[fullwidth,itemindent=1.1em,label={[\arabic*]}]
  ...
  %TODO: Aishywa's publication seems nice, where she listed conference abbreviastion in a separate column. See if I can do it?  http://pages.cs.wisc.edu/~ag/pdf/cv.pdf
        ...
        \item Anil Yelam, Kan Wu, Zhiyuan Guo, {\bf Suli Yang}, Rajath Shashidhara, Wei Xu, Stanko Novaković, Alex C Snoeren, Kimberly Keeton. \textit{{PageFlex}: Flexible and Efficient User-space Delegation of Linux Paging Policies with {eBPF}}
	In Proceedings of the 2025 USENIX Annual Technical Conference (USENIX ATC '25), MA, USA, 2025.
...
\begin{enumerate}[fullwidth,itemindent=1em,label={[\arabic*]}]
     \item Vinay Banakar, {\bf Suli Yang}, Kan Wu, Andrea C Arpaci-Dusseau, Remzi H Arpaci-Dusseau, Kimberly Keeton. \textit{Tidying Up the Address Space.} 
      Proceedings of the 3rd Workshop on Disruptive Memory Systems (DIMES' 25), Seoul, Korea, 2025.
...
\begin{itemize}
        \item HotStorage'26, Program Committee Member, \hfill 2026
	\item NSDI'24, Program Committee Member, \hfill 2023
	%\item The 21st USENIX Symposium on Networked Design and Implementation (NSDI'24), PC Member \hfill 2023
        %\item 2023 USENIX Annual Technical Conference (ATC'23), PC Member \hfill 2022
